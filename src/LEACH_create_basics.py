...
def create_sensors(my_model: Model, Positions):
    n = my_model.n
    ...
    for i, sensor in enumerate(sensors[:-1]):
        # Set x location from Positions array
        sensor.xd = Positions[i][0]
        # Set y location from Positions array
        sensor.yd = Positions[i][1]
